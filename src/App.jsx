...
function App() {
  return (
    <div className="relative min-h-screen overflow-hidden text-white">
      ...
      {/* Hero (main thumbnail area) */}
      <section className="relative px-6">
        <div className="relative mx-auto max-w-5xl overflow-hidden rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl">
          {/* Fire particles overlay bound to this thumbnail */}
          <FireParticles className="rounded-3xl" maxParticles={220} />
          ...
          <div className="relative z-10 py-12 sm:py-16">
            <div className="text-center mb-10 sm:mb-14 px-6">
              ...
              <p className="mt-4 text-white/80 max-w-2xl mx-auto">
                Move your mouse to stir the embers. Warm sparks will follow your cursor while cool tones keep the balance.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-6 pb-8">
              ...
              <div className="group relative rounded-2xl border border-orange-500/20 bg-gradient-to-br from-orange-500/10 via-rose-500/10 to-transparent p-6 sm:p-8 backdrop-blur">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <span className="text-xs text-white/70">Warm, vibrant, high-energy</span>
                </div>
              </div>
              ...
              <div className="group relative rounded-2xl border border-sky-400/20 bg-gradient-to-br from-sky-400/10 via-blue-500/10 to-transparent p-6 sm:p-8 backdrop-blur">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <span className="text-xs text-white/70">Calm, clean, refreshing</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="relative my-12 sm:my-16 flex items-center justify-center px-6">
        <div className="h-px w-full max-w-5xl bg-gradient-to-r from-orange-500/0 via-white/15 to-sky-400/0" />
